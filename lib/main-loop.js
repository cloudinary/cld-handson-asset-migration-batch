/**
 * @fileoverview This module implements the main CSV input loop for bulk-migrating data to Cloudinary
 * or bulk-updating existing Cloudinary assets.
 * 
 * It uses the async library to limit the number of concurrent operations to the Cloudinary API,
 * and logs operations performed by the script.
 */
 ...
 * @param {Object} cliParams - The parameters provided via command line interface.
